...
python -m caption.generate_critiques --critique-type insertion_error_critique --export-folder caption_export/export_20260112_1158

# Generate replacement error critiques  
python -m caption.generate_critiques --critique-type replacement_error_critique --export-folder caption_export/export_20260112_1158

# Generate deletion error critiques
python -m caption.generate_critiques --critique-type deletion_error_critique --export-folder caption_export/export_20260112_1158

# Generate non-constructive critiques
python -m caption.generate_critiques --critique-type nonconstructive_critique --export-folder caption_export/export_20260112_1158

# Generate video model critiques
python -m caption.generate_critiques --critique-type video_model_critique --export-folder caption_export/export_20260112_1158

# Generate blind model critiques
python -m caption.generate_critiques --critique-type blind_model_critique --export-folder caption_export/export_20260112_1158

# Generate worst caption
python -m caption.generate_critiques --critique-type worst_caption_generation --export-folder caption_export/export_20260112_1158
```
...
python -m caption.generate_critiques --critique-type deletion_error_critique --export-folder caption_export/export_20260112_1158 --dry-run

# Force regeneration of all critiques
python -m caption.generate_critiques --critique-type video_model_critique --export-folder caption_export/export_20260112_1158 --force-regenerate

# Use lighting project configuration
python -m caption.generate_critiques --config-type lighting --export-folder caption_export/export_20260112_1158

# Custom retry settings
python -m caption.generate_critiques --critique-type insertion_error_critique --export-folder caption_export/export_20260112_1158 --max-retries 5

# Only process videos without existing critique files
python -m caption.generate_critiques --critique-type blind_model_critique --export-folder caption_export/export_20260112_1158 --new-only

# Verbose output with progress tracking
python -m caption.generate_critiques --critique-type nonconstructive_critique --export-folder caption_export/export_20260112_1158 --verbose
```
...
**Example Output:**
- Export folder: `caption_export/export_20260112_1158`
- Generated file: `all_videos_with_captions_and_critiques_20260112_1158.json`
