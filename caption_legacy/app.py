    ...
    if st.session_state.current_step == 0:
        ...
        if score:
            ...
            if feedback_is_needed:
                ...
                filename = save_feedback_data(video_id, st.session_state.feedback_data, output_dir=output_dir)
            ...
            if score != "😀":
                ...
                if st.button("Submit Final Caption"):
                    if final_caption.strip():
                        ...
                        # Save feedback data
                        filename = save_feedback_data(st.session_state.feedback_data["video_id"], st.session_state.feedback_data, output_dir=output_dir)
