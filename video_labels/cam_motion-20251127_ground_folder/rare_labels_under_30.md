...
| --- | --- | --- | --- |
| Is it a front-side tracking shot where the camera leads the moving subject from a front-side angle? | 29 | 4867 | cam_motion.object_centric_movement.front_side_tracking_shot |
...
| Does the camera only pan rightward without any other camera movements? | 29 | 5086 | cam_motion.camera_centric_movement.pan_right.only_pan_right |
...
| Is it a rear-side tracking shot where the camera follows the moving subject at a rear-side angle? | 24 | 4872 | cam_motion.object_centric_movement.rear_side_tracking_shot |
| Does the video contain a frame freezing effect at any point? | 15 | 5100 | cam_motion.has_frame_freezing |
| Is the camera craning downward in an arc relative to its own frame? | 14 | 4544 | cam_motion.arc_crane_movement.crane_down.has_crane_down |
